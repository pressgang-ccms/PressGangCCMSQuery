...
public class PropertyTagCategoryFieldFilter extends BaseFieldFilter {
    ...
    private static final Map<String, String> filterNames = Collections.unmodifiableMap(new HashMap<String, String>() {
...

        {
            ...
            put(CommonFilterConstants.PROP_CATEGORY_DESCRIPTION_FILTER_VAR,
    ...
    protected void resetAllValues() {
        ...
        propCategoryDescription = new FilterFieldStringData(CommonFilterConstants.PROP_CATEGORY_DESCRIPTION_FILTER_VAR,
                CommonFilterConstants.PROP_CATEGORY_DESCRIPTION_FILTER_VAR_DESC);
